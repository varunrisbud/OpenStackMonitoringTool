...
router.get('/novascheduler', function(req, res, data) {
    /*fs = require('fs')
    fs.readFile('/var/log/nova/nova-scheduler.log', 'utf8', function (err,data) {
        if (err) {
    ...
    var options = {
        uri: 'http://130.65.159.58:9200/novascheduler/_search?pretty=true',
        headers : {
...
router.get('/novaapi', function(req, res, data){
    fs = require('fs')
    fs.readFile('/var/log/nova/nova-api.log', 'utf8', function (err,data) {
        if (err) {
            return console.log(err);
        }
        console.log(data);
...
router.get('/novacert', function(req, res, data){
    fs = require('fs')
    fs.readFile('/var/log/nova/nova-cert.log', 'utf8', function (err,data) {
        if (err) {
            return console.log(err);
        }
        console.log(data);
...
router.get('/novaconductor', function(req, res, data){
    fs = require('fs')
    fs.readFile('/var/log/nova/nova-conductor.log', 'utf8', function (err,data) {
        if (err) {
            return console.log(err);
        }
        console.log(data);
...
router.get('/novanovncproxy', function(req, res, data){
    fs = require('fs')
    fs.readFile('/var/log/nova/nova-novncproxy.log', 'utf8', function (err,data) {
        if (err) {
            return console.log(err);
        }
        console.log(data);
...
router.get('/novaconsoleauth', function(req, res, data){
    fs = require('fs')
    fs.readFile('/var/log/nova/nova-consoleauth.log', 'utf8', function (err,data) {
        if (err) {
            return console.log(err);
        }
        console.log(data);
